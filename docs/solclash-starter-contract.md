...
2. Required Layout
   ...
   canonical starter template for `btc-perp-v1` lives at
   `packages/arenas/arenas/btc-perp-v1/starter/`, so the program lives at
...
```rust
// packages/arenas/arenas/btc-perp-v1/starter/program/src/lib.rs
